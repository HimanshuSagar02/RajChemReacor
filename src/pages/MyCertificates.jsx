        ...
        {certificates.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
            ...
            <button
              ...
              className="px-6 py-3 bg-black text-[#FFD700] font-bold rounded-xl hover:bg-gray-900 transition-all"
            >
              View My Courses
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {certificates.map((cert) => (
              <div
                ...
                className="bg-white rounded-2xl shadow-xl p-6 border-2 border-gray-200 hover:border-[#FFD700] transition-all hover:shadow-2xl"
              >
                {/* Certificate Icon */}
                <div className="text-center mb-4">
                  <div className="w-20 h-20 bg-gradient-to-br from-[#FFD700] to-yellow-400 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-black text-[#FFD700] font-semibold rounded-lg hover:bg-gray-900 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#FFD700] text-black font-semibold rounded-lg hover:bg-[#FFC107] transition-all flex items-center justify-center gap-2"
                  >
                    <FaQrcode />
                    Verify
                  </button>
