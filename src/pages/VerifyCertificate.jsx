  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-black via-gray-900 to-black rounded-2xl shadow-2xl p-6 md:p-8 mb-6 border-2 border-[#FFD700] text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            <FaShieldAlt className="text-4xl md:text-5xl text-[#FFD700]" />
            <h1 className="text-3xl md:text-4xl font-bold text-[#FFD700]">
              Certificate Verification
            </h1>
          </div>
          <p className="text-white text-sm md:text-base">
            Verify the authenticity of RCR certificates using Certificate ID or QR Code
          </p>
        </div>
            ...
            <form onSubmit={handleSearch} className="space-y-4">
              ...
              <div className="flex gap-3">
                <input
                  ...
                  placeholder="RCR-YYYYMMDD-XXXXXX"
                  className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-[#FFD700] transition-colors text-gray-900 font-mono"
                  required
                />
                <button
                  type="submit"
                  className="px-6 py-3 bg-black text-[#FFD700] font-bold rounded-xl hover:bg-gray-900 transition-all shadow-lg flex items-center gap-2"
                >
                  <FaQrcode /> Verify
                </button>
              </div>
              <p className="text-sm text-gray-600">
                Enter the Certificate ID found on the certificate (e.g., RCR-20241215-ABC123)
              </p>
            </form>
          </div>
        )}
        ...
        {!loading && certificate && (
          <div className="space-y-6">
            ...
            {/* Certificate Details */}
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 border-2 border-[#FFD700]">
              <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-gray-200">
                <FaCertificate className="text-3xl text-[#FFD700]" />
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
                  <div className="flex items-center gap-2 mb-2">
                    <FaQrcode className="text-[#FFD700]" />
