      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-black via-gray-900 to-black rounded-2xl shadow-2xl p-8 mb-8 border-2 border-[#FFD700] relative overflow-hidden">
          ...
          <div className="relative z-10 flex justify-between items-center">
            <div>
              <h1 className="text-4xl font-bold text-[#FFD700] mb-2">Feedback Management</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8 border-2 border-gray-100">
          <div className="flex items-center gap-3 mb-4">
            <FaFilter className="text-[#FFD700] text-xl" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                className="w-full h-12 px-4 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-[#FFD700]"
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {feedbacks.map((feedback) => (
                <div
                  key={feedback._id}
                  className="border-2 border-gray-200 rounded-xl p-6 hover:border-[#FFD700] transition-all"
                >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        {feedback.feedbackType === "teacher" ? (
                          ...
                          <FaBuilding className="text-[#FFD700] text-xl" />
                        )}
                    ...
                    <div className="flex items-center gap-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <FaStar
                          key={star}
                          className={`text-xl ${
                            star <= feedback.rating ? "text-[#FFD700]" : "text-gray-300"
                          }`}
                        />
                      ))}
                  ...
                  {feedback.adminResponse && (
                    <div className="bg-[#FFD700] bg-opacity-10 border-l-4 border-[#FFD700] p-4 rounded-lg mb-4">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="px-4 py-2 bg-black text-[#FFD700] font-semibold rounded-lg hover:bg-gray-900 transition-all"
                    >
                      Update Status
                    </button>
                  </div>
            ...
            <div className="bg-white rounded-2xl p-8 max-w-md w-full">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    className="w-full h-24 px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-[#FFD700] resize-none"
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-black text-[#FFD700] font-bold rounded-xl hover:bg-gray-900 transition-all"
                  >
                    Update
                  </button>
                  <button
