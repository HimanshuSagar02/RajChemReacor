      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      <BarChart data={courseProgressData}>
                        ...
                        <YAxis />
                        <Tooltip />
                        <Bar dataKey="lectures" fill="#FFD700" radius={[5, 5, 0, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      <BarChart data={enrollData}>
                        ...
                        <YAxis />
                        <Tooltip />
                        <Bar dataKey="enrolled" fill="#FFD700" radius={[5, 5, 0, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </div>
          ...
          {activeTab === "courses" && (
            <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
              <div className="w-20 h-20 bg-[#FFD700] bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaBook className="text-5xl text-[#FFD700]" />
              </div>
              ...
              <button
                onClick={() => navigate("/courses")}
                className="bg-black text-[#FFD700] font-bold px-8 py-3 rounded-xl hover:bg-gray-900 transition-all shadow-lg flex items-center gap-2 mx-auto"
              >
          ...
          {activeTab === "assignments" && (
            <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
              <div className="w-20 h-20 bg-[#FFD700] bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaClipboardList className="text-5xl text-[#FFD700]" />
              </div>
          ...
          {activeTab === "students" && (
            <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
              <div className="w-20 h-20 bg-[#FFD700] bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaUsers className="text-5xl text-[#FFD700]" />
              </div>
          ...
          {activeTab === "attendance" && (
            <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
              <div className="w-20 h-20 bg-[#FFD700] bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaCalendarCheck className="text-5xl text-[#FFD700]" />
              </div>
          ...
          {activeTab === "notifications" && (
            <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
              <div className="w-20 h-20 bg-[#FFD700] bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaBell className="text-5xl text-[#FFD700]" />
              </div>
          ...
          {activeTab === "liveclasses" && (
            <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
              <div className="w-20 h-20 bg-[#FFD700] bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaVideo className="text-5xl text-[#FFD700]" />
              </div>
          ...
          {activeTab === "grades" && (
            <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
              <div className="w-20 h-20 bg-[#FFD700] bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaGraduationCap className="text-5xl text-[#FFD700]" />
              </div>
          ...
          {activeTab === "doubts" && (
            <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
              <div className="w-20 h-20 bg-[#FFD700] bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaQuestionCircle className="text-5xl text-[#FFD700]" />
              </div>
