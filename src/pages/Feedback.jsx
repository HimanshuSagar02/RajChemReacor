...
import { FaStar, FaUser, FaBuilding, FaCheckCircle, FaTimesCircle } from "react-icons/fa";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-black via-gray-900 to-black rounded-2xl shadow-2xl p-8 mb-8 border-2 border-[#FFD700] relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h1 className="text-4xl font-bold text-[#FFD700] mb-2">Submit Feedback</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {feedbackType === "teacher" && (
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    className="w-full h-12 px-4 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-[#FFD700] transition-colors"
            ...
            <div>
              ...
              <textarea
                className="w-full h-32 px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-[#FFD700] transition-colors resize-none"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-black text-[#FFD700] font-bold rounded-xl hover:bg-gray-900 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-100">
            ...
            <div className="space-y-4">
              {myFeedbacks.map((feedback) => (
                <div
                  key={feedback._id}
                  className="border-2 border-gray-200 rounded-xl p-5 hover:border-[#FFD700] transition-all"
                >
