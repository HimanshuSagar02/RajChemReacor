        ...
        <div className="flex flex-col md:flex-row gap-6 ">
          ...
          <div className="flex-1 space-y-2 mt-[20px]">
            ...
            {userData?.role === "student" && (
              !isEnrolled ? (
                <button className="bg-[black] text-[#FFD700] px-6 py-2 rounded hover:bg-gray-800 border border-[#FFD700] mt-3" onClick={()=>handleEnroll(courseId , userData._id)}>
                  Enroll Now
                </button>
              ) : (
...
<div className="mt-8 border-t pt-6">
    ...
    <div className="mb-4">
      ...
      <button
        ...
        className="bg-black text-[#FFD700] mt-3 px-4 py-2 rounded hover:bg-gray-800 border border-[#FFD700]" onClick={handleReview}
      >
        Submit Review
      </button>
    </div>
