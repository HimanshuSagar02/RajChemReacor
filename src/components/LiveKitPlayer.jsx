...
function LiveKitPlayer({ liveClassId, userRole, onClose, isEducator = false }) {
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center text-white">
                ...
                <button
                  ...
                  className="mt-4 px-6 py-2 bg-[#FFD700] text-black rounded-lg font-semibold hover:bg-[#FFC107]"
                >
                  Retry Connection
                </button>
              </div>
          ...
          <div className="w-80 bg-gray-900 border-l border-gray-700 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-2">
              {chatMessages.map((msg) => (
                <div key={msg.id} className="text-sm">
                  <span className="font-semibold text-[#FFD700]">{msg.sender}:</span>
            ...
            <div className="p-4 border-t border-gray-700 flex gap-2">
              <input
                ...
                className="flex-1 bg-gray-800 text-white px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FFD700]"
                disabled={!isConnected}
              />
              <button
                onClick={sendChatMessage}
                disabled={!isConnected || !chatInput.trim()}
                className="px-4 py-2 bg-[#FFD700] text-black rounded-lg font-semibold hover:bg-[#FFC107] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Send
              </button>
            </div>
        ...
        <div className="bg-black border-t border-gray-700 p-4 flex items-center justify-center gap-4">
          ...
          {isEducator && (
            <button
              ...
              className={`p-3 rounded-lg transition-colors ${
                isScreenSharing ? "bg-[#FFD700] text-black hover:bg-[#FFC107]" : "bg-gray-700 text-white hover:bg-gray-600"
              }`}
              title="Share screen"
            >
