...
function AIAssistant() {
  ...
  const createdCourses = courseData?.filter(
    (c) => c.creator?._id === userData?._id || c.creator === userData?._id
  ) || [];

  const availableCourses = userData?.role === "student" ? enrolledCourses : createdCourses;
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-black border-2 border-[#FFD700] text-[#FFD700] p-4 rounded-full shadow-2xl hover:shadow-3xl transition-all hover:scale-110 hover:bg-[#FFD700] hover:text-black flex items-center justify-center"
        title="AI Assistant"
      >
      ...
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-96 h-[85vh] bg-white rounded-lg shadow-2xl flex flex-col border-2 border-gray-200">
          {/* Header */}
          <div className="bg-black border-b-2 border-[#FFD700] text-[#FFD700] p-4 rounded-t-lg flex justify-between items-center">
          ...
          <div className="flex border-b overflow-x-auto">
            <button
              ...
              className={`px-3 py-2 text-sm font-medium whitespace-nowrap ${
                activeFeature === "tutor"
                  ? "bg-[#FFD700] text-black border-b-2 border-[#FFD700]"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-black text-[#FFD700] border border-[#FFD700] rounded-lg hover:bg-[#FFD700] hover:text-black transition-colors disabled:opacity-50"
                    >
                      Send
                    </button>
                  </div>
